...
# Allow running from the source tree without requiring installation.
# `mask_mod_definitions.py` lives under `tests/cute/`.
_REPO_ROOT = Path(__file__).resolve().parents[1]
_TESTS_CUTE_DIR = _REPO_ROOT / "tests" / "cute"
for _p in (_REPO_ROOT, _TESTS_CUTE_DIR):
    _ps = str(_p)
